...
Version  : 0.7.0
Release  : 28
URL      : https://github.com/tiran/defusedxml/archive/v0.7.0/defusedxml-0.7.0.tar.gz
Source0  : https://github.com/tiran/defusedxml/archive/v0.7.0/defusedxml-0.7.0.tar.gz
...
%prep
%setup -q -n defusedxml-0.7.0
cd %{_builddir}/defusedxml-0.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614871692
...
cp %{_builddir}/defusedxml-0.7.0/LICENSE %{buildroot}/usr/share/package-licenses/defusedxml/c0a4a8cdd88e9432b6dae397e751cfe61ba6ed88
