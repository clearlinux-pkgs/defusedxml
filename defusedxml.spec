...
pushd ..
cp -a defusedxml-0.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701949366
...
cp %{_builddir}/defusedxml-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/defusedxml/c0a4a8cdd88e9432b6dae397e751cfe61ba6ed88 || :
